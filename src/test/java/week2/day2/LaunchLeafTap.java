...
public class LaunchLeafTap {
	public static void main(String[] args) {
		...
		WebElement eleUsername = driver2.findElement(By.xpath("//input[@id='username']"));
		eleUsername.sendKeys("DemoCsr");

		WebElement elePassword = driver2.findElement(By.xpath("//input[@id='password']"));
		elePassword.sendKeys("crmsfa");

		WebElement eleLogin = driver2.findElement(By.className("decorativeSubmit"));
		eleLogin.click();

		WebElement crmSFA = driver2.findElement(By.xpath("//a[contains(text(), 'CRM/SFA')]"));
		crmSFA.click();
		
		WebElement lead = driver2.findElement(By.xpath("//a[contains(text(), 'Leads')]"));
		lead.click();
		
		WebElement createLead = driver2.findElement(By.xpath("//a[contains(text(), 'Create Lead')]"));//partial text
		createLead.click();
